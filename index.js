...
var ASM_CONSTS = [function() { alert('Map Unsolvable Refreshing') },
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_main_cc() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
var real___GLOBAL__sub_I_main_cc = asm["__GLOBAL__sub_I_main_cc"]; asm["__GLOBAL__sub_I_main_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_main_cc.apply(null, arguments);
};

var real___Z10getGameMapv = asm["__Z10getGameMapv"]; asm["__Z10getGameMapv"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___Z10getGameMapv.apply(null, arguments);
};

var real___Z8gameLoopi = asm["__Z8gameLoopi"]; asm["__Z8gameLoopi"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___Z8gameLoopi.apply(null, arguments);
};
...
var __GLOBAL__sub_I_main_cc = Module["__GLOBAL__sub_I_main_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_main_cc"].apply(null, arguments) };
var __Z10getGameMapv = Module["__Z10getGameMapv"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__Z10getGameMapv"].apply(null, arguments) };
var __Z8gameLoopi = Module["__Z8gameLoopi"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__Z8gameLoopi"].apply(null, arguments) };
